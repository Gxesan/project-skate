...
class StartScene(SceneBase):
    ...
    def Render(self, screen):
        ...
        screen.blit(self.button1text, (half_of(screen.get_width()) - 137.5, half_of(screen.get_height()) + 19))
        screen.blit(self.button2text, (half_of(screen.get_width()) - 137.5, half_of(screen.get_height()) + 119))
        screen.blit(self.button3text, (half_of(screen.get_width()) - 137.5, half_of(screen.get_height()) + 219))
        pygame.display.flip()
